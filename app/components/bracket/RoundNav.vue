...
<template>
    <div class="flex overflow-x-auto pb-2 xl:pb-0 gap-1 scrollbar-hide">
        <button v-for="round in rounds" :key="round.id" :disabled="round.isDisabled"
            ...
            :class="round.id === activeRoundId
                ? 'bg-cyber-cyan/10 text-cyber-cyan border border-cyber-cyan/30 shadow-[0_0_10px_rgba(0,240,255,0.3)]'
